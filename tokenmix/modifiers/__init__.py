def get_modifier(method: str, model_type):
    if method == 'enc13':
        ...
        if model_type == 'llama':
            from .modify_llama_enc19 import LlamaENC19
            return None, LlamaENC19
    elif method == 'enc20':
        if model_type == 'llama':
        ...
        if model_type == 'llama':
            ...
            from .modify_qwen_hybird3 import QwenHybird3
            return None, QwenHybird3
    elif method == 'hybird4':
        if model_type == 'llama':
        ...
        if model_type == 'llama':
            from .modify_llama_hybirdx import LlamaHybirdX
            return None, LlamaHybirdX
    elif method == 'hybird9visualize':
        if model_type == 'llama':
            from .modify_llama_hybird9_visualize import LlamaHybird9Visualize
            return None, LlamaHybird9Visualize
    elif method == "tinyllama":
        from .modify_tinyllama import TinyLlama
        return None, TinyLlama
    elif method == "origin_lora":
        from .modify_llama_origin_lora import LlamaOriginLoRA
        return None, LlamaOriginLoRA
    elif method == 'flash':
        from .modify_llama_flash import LlamaFlash
        return None, LlamaFlash
    elif method == 'visualize_origin':
        from .modify_llama_visualize_origin import LlamaOrigin
        return None, LlamaOrigin
    elif method == 'visualize_chunk':
        from .modify_llama_visualize_chunk import LlamaChunk
        return None, LlamaChunk
    elif method == 'latency_origin_costum':
        from .modify_llama_latency_origin_custom import LlamaOrigin
        return None, LlamaOrigin
    elif method == 'latency_origin_sdpa':
        from .modify_llama_latency_origin_sdpa import LlamaOrigin
        return None, LlamaOrigin
    elif method == 'latency_origin_flash':
        from .modify_llama_latency_origin_flash import LlamaOrigin
        return None, LlamaOrigin
    elif method == 'shrink':
        from .modify_llama_shrink_attn import LlamaShrink
        return None, LlamaShrink
    elif method == 'isorope':
        from .modify_llama_isorope import LlamaIsoRoPE
        return None, LlamaIsoRoPE
    elif method == 'isorope2':
        from .modify_llama_isorope2 import LlamaIsoRoPE2
        return None, LlamaIsoRoPE2
    elif method == 'origin':
